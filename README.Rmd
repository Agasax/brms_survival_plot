...
We then estimate the expected the survival probability and hazard for each treatment group at each time point, marginalising over the population in the style of the `comparisons` function from the `marginaleffects` package.
